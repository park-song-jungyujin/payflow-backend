...
RUN pip install --no-cache-dir fastapi "uvicorn[standard]" google-auth requests python-dotenv google-cloud-firestore google-cloud-tasks google-cloud-storage openpyxl python-ulid pydantic google-genai
